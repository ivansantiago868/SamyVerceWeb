...
def asignar_permisos_archivo3mf(apps, schema_editor):
    ...
    codenames = [
        "add_figuraarchivo3mf", "change_figuraarchivo3mf",
        "delete_figuraarchivo3mf", "view_figuraarchivo3mf",
    ]
...
def revocar_permisos_archivo3mf(apps, schema_editor):
    Group      = apps.get_model("auth", "Group")
    Permission = apps.get_model("auth", "Permission")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("produccion", "0046_remove_figura_archivo_3mf_figuraarchivo3mf"),
    ]

    operations = [
        migrations.RunPython(asignar_permisos_archivo3mf, revocar_permisos_archivo3mf),
    ]
